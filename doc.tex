...
\begin{codebox}
    ...
    \[ \print*{q} \] 
\end{codebox}
Alice is slightly disappointed that $0+2x$ is returned and not $2x$. Alice takes a guess that there's a \mintinline{lua}{:simplify()} method. This does the trick: adding the line \mintinline{lua}{q = q:simplify()} before leaving the \texttt{CAS} environment returns the expected $2x$.
