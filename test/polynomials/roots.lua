...
testeq(b:roots(), "{(-1/48 + (-1/48 * sqrt(383,2) * i)), (-1/48 + (1/48 * sqrt(383,2) * i))}", b, true)
...
testeq(n:roots(), "{-4, -3, -2, -1, i, (-1 * i), (-1/2 * ((2 + (-2 * sqrt(3,2) * i)) ^ 1/2)), (1/2 * ((2 + (-2 * sqrt(3,2) * i)) ^ 1/2)), (-1/2 * ((2 + (2 * sqrt(3,2) * i)) ^ 1/2)), (1/2 * ((2 + (2 * sqrt(3,2) * i)) ^ 1/2))}", n, true)
testeq(o:roots(), "{-4, -3, -2, -1, i, (-1 * i)}", o, true)
testeq(p:roots(), "{24, (12 + (-4 * sqrt(6,2))), (12 + (4 * sqrt(6,2))), (-4 * sqrt(6,2) * i), (4 * sqrt(6,2) * i)}", p, true)
testeq(q:roots(), "{(1/4 + (-1/2 * ((-3/4 + (-1/3 * sqrt(3,2) * i)) ^ 1/2))), (1/4 + (1/2 * ((-3/4 + (-1/3 * sqrt(3,2) * i)) ^ 1/2))), (1/4 + (-1/2 * ((-3/4 + (1/3 * sqrt(3,2) * i)) ^ 1/2))), (1/4 + (1/2 * ((-3/4 + (1/3 * sqrt(3,2) * i)) ^ 1/2)))}", q, true)
testeq(r:roots(), "{0}", r, true)
testeq(s:roots(), "{(-1/2 * ((8 + (-4 * sqrt(3,2))) ^ 1/2)), (1/2 * ((8 + (-4 * sqrt(3,2))) ^ 1/2)), (-1/2 * ((8 + (4 * sqrt(3,2))) ^ 1/2)), (1/2 * ((8 + (4 * sqrt(3,2))) ^ 1/2))}", s, true)
testeq(t:roots(), "{(-1/3 + (-4/3 * ((19 + (3 * sqrt(33,2))) ^ -1/3)) + (-1/3 * ((19 + (3 * sqrt(33,2))) ^ 1/3))), (-1/3 + (-4/3 * ((19 + (3 * sqrt(33,2))) ^ -1/3) * ((-1/2 + (1/2 * sqrt(3,2) * i)) ^ -1)) + (-1/3 * ((19 + (3 * sqrt(33,2))) ^ 1/3) * (-1/2 + (1/2 * sqrt(3,2) * i)))), (-1/3 + (-4/3 * ((19 + (3 * sqrt(33,2))) ^ -1/3) * ((-1/2 + (1/2 * sqrt(3,2) * i)) ^ -2)) + (-1/3 * ((19 + (3 * sqrt(33,2))) ^ 1/3) * ((-1/2 + (1/2 * sqrt(3,2) * i)) ^ 2)))}", t, true)
endtest()