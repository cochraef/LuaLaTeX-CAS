...
test(n:roots(), "{-4, -3, -2, -1, i, (-1 * i), (-1/2 * ((2 + (-2 * sqrt(3,2) * i)) ^ 1/2)), (1/2 * ((2 + (-2 * sqrt(3,2) * i)) ^ 1/2)), (-1/2 * ((2 + (2 * sqrt(3,2) * i)) ^ 1/2)), (1/2 * ((2 + (2 * sqrt(3,2) * i)) ^ 1/2))}", n, true)
test(o:roots(), "{-4, -3, -2, -1, i, (-1 * i)}", o, true)
test(p:roots(), "{24, (12 + (-4 * sqrt(6,2))), (12 + (4 * sqrt(6,2))), (-4 * sqrt(6,2) * i), (4 * sqrt(6,2) * i)}", p, true)
test(q:roots(), "{(1/4 + (-1/2 * ((-3/4 + (-1/3 * sqrt(3,2) * i)) ^ 1/2))), (1/4 + (1/2 * ((-3/4 + (-1/3 * sqrt(3,2) * i)) ^ 1/2))), (1/4 + (-1/2 * ((-3/4 + (1/3 * sqrt(3,2) * i)) ^ 1/2))), (1/4 + (1/2 * ((-3/4 + (1/3 * sqrt(3,2) * i)) ^ 1/2)))}", q, true)
test(r:roots(), "{0}", r, true)
test(s:roots(), "{(-1/2 * ((8 + (-4 * sqrt(3,2))) ^ 1/2)), (1/2 * ((8 + (-4 * sqrt(3,2))) ^ 1/2)), (-1/2 * ((8 + (4 * sqrt(3,2))) ^ 1/2)), (1/2 * ((8 + (4 * sqrt(3,2))) ^ 1/2))}", s, true)
test(t:roots(), "{(-1/3 + (-4/3 * ((19 + (3 * sqrt(33,2))) ^ -1/3)) + (-1/3 * ((19 + (3 * sqrt(33,2))) ^ 1/3))), (-1/3 + (-4/3 * ((19 + (3 * sqrt(33,2))) ^ -1/3) * ((-1/2 + (1/2 * sqrt(3,2) * i)) ^ -1)) + (-1/3 * ((19 + (3 * sqrt(33,2))) ^ 1/3) * (-1/2 + (1/2 * sqrt(3,2) * i)))), (-1/3 + (-4/3 * ((19 + (3 * sqrt(33,2))) ^ -1/3) * ((-1/2 + (1/2 * sqrt(3,2) * i)) ^ -2)) + (-1/3 * ((19 + (3 * sqrt(33,2))) ^ 1/3) * ((-1/2 + (1/2 * sqrt(3,2) * i)) ^ 2)))}", t, true)
endtest()