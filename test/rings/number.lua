...
test(f:primefactorization(), "(* (3 ^ 1))", f, true)
test(g:primefactorization(), "((2 ^ 3) * (3 ^ 3))", g, true)
test(h:primefactorization(), "((3 ^ 3) * (5 ^ 1) * (7 ^ 1))", h, true)
test(i:primefactorization(), "((41 ^ 1) * (189439 ^ 1))", i, true)
test(o:primefactorization(), "((10007 ^ 1) * (20011 ^ 1))", o, true)
endtest()