...
-- print(ToStringArray(c:decompose()))
-- print(ToStringArray(h:decompose()))
-- print(ToStringArray(k:decompose()))
-- print(ToStringArray(j:decompose()))
-- print(ToStringArray(k:decompose()))
-- print(ToStringArray(l:decompose()))
-- print(ToStringArray(m:decompose()))
-- print(ToStringArray(b:decompose()))
-- print(ToStringArray(o:decompose()))
-- print(ToStringArray(n:decompose()))
print(ToStringArray(q:decompose()))