...
\section{Core}
    ...
    \begin{itemize}
        \item {\error\ttfamily\itshape method}: a method that returns an error; 
        \item {\self\ttfamily\itshape method}: a method that returns itself; 
        \item {\ttfamily\itshape method}: a new method or an old method that does something different than what it inherits;
        \item {\tikz[baseline=-0.5ex]\node[fill=roseblue!50] {\ttfamily\bfseries Class};}: a callable class.
    \end{itemize}
    \vfill
\forestset{
