...
\coderef{function Expression:evaluate()}{return Expression}{evaluate}
...
\coderef{function Expression:autosimplify()}{return Expression}{autosimplify}
...
\coderef{function Expression:simplify()}{return Expression}{simplify}
...
\coderef{function Expression:subexpressions()}{return table<number, Expression>}{subexpressions}
...
\coderef{function Expression:size()}{return Integer}{size}
...
\coderef{function Expression:setsubexpressions(subexpressions)}{return Expression}{setsubexpressions}
...
\coderef{function Expression:freeof(symbol)}{return bool}{freeof}
...
\coderef{function Expression:substitute(map)}{return Expression}{substitute}
...
\coderef{function Expression:expand()}{return Expression}{expand}
...
\coderef{function Expression:factor()}{return Expression}{factor}
...
\coderef{function Expression:isatomic()}{return bool}{isatomic}
...
\coderef{function Expression:isconstant()}{return bool}{isconstant}
...
\coderef{function Expression:isrealconstant()}{return bool}{isrealconstant}

Determines whether an expression is a real number in the mathematical sense, such as $2$, $\sqrt{5}$, or $\sin(3)$.

\coderef{function Expression:iscomplexconstant()}{return bool}{iscomplexconstant}

Determines whether an expression is a complex number in the mathematical sense, such as $3 + \sqrt{2}i$.

\coderef{function Expression:tolatex()}{return string}{tolatex}
