...
If the polynomial is defined over $\mathbf{Z}_p$ (where $p$ is prime), then the method \texttt{modularsquarefreefactorization()} should be used. 
...
Returns the greatest common divisor of \texttt{a,b}. 

\newcoderef{function Integer.extendedgcd(a,b)}{return Integer, Integer, Integer}{a Integer, b Integer}

Returns the greatest common divisor of \texttt{a,b} as well as Bezout's coefficients via extended gcd.
