...
\begin{abstract}
    The package {\ttfamily luacas} is a portable Computer Algebra System capable of symbolic computation, written entirely in Lua, designed for use in Lua\LaTeX{}.
\end{abstract}
